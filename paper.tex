...
\author{Jacobus C. Lock\inst{1} \and
  ...
  Andrea G. Tramontano\inst{2} \and
...
The data for the search times for each dataset are displayed in Fig~\ref{fig:boxplot-time}.%, while Fig.~\ref{fig:cum-time} shows the cumulative distribution functions (CDF) for the search times as a function of the total number of objects found.
