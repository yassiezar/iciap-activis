...
They typically reach higher accuracy, but at the cost of increased memory and computational resource requirements.\todo{cite}
...
The network was trained with a maximum of 10000 annotated images for each object class in $\mathbf{A}$ with a 60\%/20\%/20\% split for training, validation and testing respectively.
